...
public interface TimerRegistry extends Registry<Timer, TimerConfig> {
  static TimerRegistry ofDefaults() {
    return ofMetricRegistry(new MetricRegistry());
  }

  static TimerRegistry ofMetricRegistry(MetricRegistry metricRegistry) {
    return new InMemoryTimerRegistry(metricRegistry);
  }

  Timer timer(String name, TimerConfig timerConfig);
