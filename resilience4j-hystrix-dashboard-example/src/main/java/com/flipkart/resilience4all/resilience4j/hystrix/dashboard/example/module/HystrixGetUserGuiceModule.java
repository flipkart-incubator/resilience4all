...
import com.flipkart.resilience4all.resilience4j.hystrix.dashboard.example.service.HystrixGetUserService;
...
public class HystrixGetUserGuiceModule implements Module {
  @Override
  ...
  public GetUserService providesResilience4jGetUserService(
    ...
    return new HystrixGetUserService(getUsersService);
  }
}
