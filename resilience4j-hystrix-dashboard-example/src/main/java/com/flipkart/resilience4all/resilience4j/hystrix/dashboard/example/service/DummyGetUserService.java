...
public class DummyGetUserService implements GetUserService {
  @Override
  public UserDetails getUser(int id) {
    Utils.addRandomArtificalDelay(200);
    return new UserDetails(id, "someEmailId", "someFirstName", "someLastName");
  }
}
